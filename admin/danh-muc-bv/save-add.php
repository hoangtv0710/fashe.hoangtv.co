<?php 
	...
	if($name == ""){
		header('location: '. SITELINKADMIN . '/danh-muc-bv/add.php?errName=Không để trống tên danh mục!&name='.$name.'&description='.$description);
		die;
	}
	...
	header('location: '. SITELINKADMIN . '/danh-muc-bv?success=true');
	die;
 ?>